...
def summarize_text(text):
    ...
    with torch.no_grad():
        summary_ids = model.generate(
            inputs["input_ids"],
            max_length=36,  # 더 짧은 요약
            min_length=15,  # 최소 길이도 줄임
            num_beams=6,  # 더 많은 빔 서치
            temperature=0.5,  # 더 보수적인 생성
            top_k=20,  # 상위 20개 토큰으로 제한
            top_p=0.85,  # 더 보수적인 샘플링
            repetition_penalty=2.5,  # 반복 제한
            length_penalty=0.8,  # 짧은 문장 선호
